...
const doTranslate = (key, interpolate, children) => {
    ...
    const preRender = data ? (0, lodash_get_1.default)(data, key) || deepFindDirty(data, key) : null;
...
class Translate extends react_1.default.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return nextState.lastChange !== translator_context_1.default.context.lastChange;
    }
    render() {
