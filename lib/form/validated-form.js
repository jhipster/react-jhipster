...
function ValidatedForm(_a) {
    var { defaultValues, form, children, onSubmit, mode } = _a, rest = tslib_1.__rest(_a, ["defaultValues", "form", "children", "onSubmit", "mode"]);
    const { handleSubmit, register, 
    // setValue,
    formState: { errors, touchedFields, dirtyFields }, } = form;
    return (react_1.default.createElement(reactstrap_1.Form, Object.assign({ onSubmit: handleSubmit(onSubmit) }, rest), react_1.default.Children.map(children, (child) => {
        ...
        if (isValidated) {
            ...
            const defaultValue = form === null || form === void 0 ? void 0 : form.defaultValues[childName];
            const elem = Object.assign(Object.assign({}, child.props), { register: child.props.register || register, error: child.props.error || errors[childName], isTouched: typeof child.props.isTouched === 'undefined' ? touchedFields[childName] : child.props.isTouched, isDirty: typeof child.props.isDirty === 'undefined' ? dirtyFields[childName] : child.props.isDirty, 
                // setValue: typeof child.props.setValue === 'undefined' ? setValue : child.props.setValue,
                defaultValue: typeof child.props.defaultValue === 'undefined' ? defaultValue : child.props.defaultValue, key: childName });
...
function ValidatedInput(_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        error && react_1.default.createElement(reactstrap_1.FormFeedback, null, error.message.toString())));
}
...
function ValidatedBlobField(_a) {
    var { name, register, setValue, error, isTouched, isDirty, validate, children, className, onChange, onBlur, id = name, disabled, row, col, tag, label, labelClass, labelHidden, inputClass, inputTag, hidden, defaultValue, defaultContentType, isImage, imageStyle, imageClassName, clearBtn, openActionLabel, blob, setBlobData, blobContentType, setBlobContentType, 
    // will be ignored as type will always be `file`
    type, check } = _a, attributes = tslib_1.__rest(_a, ["name", "register", "setValue", "error", "isTouched", "isDirty", "validate", "children", "className", "onChange", "onBlur", "id", "disabled", "row", "col", "tag", "label", "labelClass", "labelHidden", "inputClass", "inputTag", "hidden", "defaultValue", "defaultContentType", "isImage", "imageStyle", "imageClassName", "clearBtn", "openActionLabel", "blob", "setBlobData", "blobContentType", "setBlobContentType", "type", "check"]);
