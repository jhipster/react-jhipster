...
function ValidatedTextInput({ register, touchedFields, errors, setValue, name, validate, labelPlaceholderKey, inputPlaceholderKey, type = 'text', updateValueOverrideMethod, }) {
    var _a;
    ...
    return (react_1.default.createElement(reactstrap_1.FormGroup, null,
        ...
        react_1.default.createElement(reactstrap_1.Input, Object.assign({ id: name, name: name, placeholder: (0, language_1.translate)(inputPlaceholderKey), type: type }, register(name, validate), { "data-cy": name, valid: touchedFields[name] && !errors[name], invalid: !touchedFields[name] || !!errors[name], onChange: updateValue })),
