...
describe('JhiItemCountComponent test', function () {
    describe('UI logic tests', function () {
        it('should change the content on page change', function () {
            var rerender = (0, react_1.render)(React.createElement(item_count_1.JhiItemCount, { page: 1, itemsPerPage: 10, total: 100 })).rerender;
    ...
    describe('Translation tests', function () {
        it('should change on language change', function () {
            ...
            var mountedWrapper = (0, react_1.render)(React.createElement(item_count_1.JhiItemCount, { page: 1, itemsPerPage: 10, total: 100, i18nEnabled: true }));
            expect(mountedWrapper.getByText('Showing 1 - 10 of 100 items.')).not.toBeNull();
            language_1.TranslatorContext.setLocale('fr');
            var mountedWrapperFr = (0, react_1.render)(React.createElement(item_count_1.JhiItemCount, { page: 1, itemsPerPage: 10, total: 100, i18nEnabled: true }));
