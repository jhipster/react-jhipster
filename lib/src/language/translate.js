...
var lodash_get_1 = (0, tslib_1.__importDefault)(require("lodash.get"));
...
var toTemplate = function (string) {
    ...
    return (0, tslib_1.__spreadArray)([string.split(expressionRe)], match, true);
};
...
var render = function (string, values) {
    ...
    return flatten(parts.reduce(function (acc, item, index, array) {
        if (index === array.length - 1) {
            return (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], acc, true), [item], false);
        }
        var match = expressions[index] && expressions[index].match(/{{\s?(\w+)\s?}}/);
        var value = match != null ? values[match[1]] : null;
        return (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], acc, true), [item, normalizeValue(value, index)], false);
    }, []));
};
/**
...
var Translate = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(Translate, _super);
    function Translate() {
