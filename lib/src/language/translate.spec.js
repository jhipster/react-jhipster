...
describe('Translate', function () {
    describe('without translations', function () {
        it('renders nothing when no translations are not loaded', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.bar" })).container;
    ...
    describe('with translation', function () {
        ...
        it('renders child content when key is invalid and renderInnerTextForMissingKeys is true', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.baz" }, "def text")).container;
        ...
        it('renders key-missing message when child content is null & key is invalid', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.baz" })).container;
            var span = container.querySelector('span');
        ...
        it('renders key-missing message when key is invalid & interpolate argument given', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.baz", interpolate: { foo: 'FOO', bar: 'BAR' } }, "def text")).container;
            var span = container.querySelector('span');
            expect(span.innerHTML).toBe('translation-not-found[foo.baz]');
        });
        ...
        it('renders a default span with translated content for dirty key 1', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.baz.foo" })).container;
            var span = container.querySelector('span');
            expect(span.innerHTML).toBe('dirty key');
        });
        it('renders a default span with translated content for dirty key 2', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.bar1.bar2.bar3" })).container;
            var span = container.querySelector('span');
            expect(span.innerHTML).toBe('bar123');
        });
        it('renders a default span with translated content for dirty key 3', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.bar4.bar5.bar6" })).container;
            var span = container.querySelector('span');
            expect(span.innerHTML).toBe('bar456');
        });
        it('renders a default span with translated content for dirty key 4', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.bar7.bar8.bar9.bar10.bar11" })).container;
            var span = container.querySelector('span');
            expect(span.innerHTML).toBe('bar7891011');
        });
        it('renders a provided component with translated content', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.bar", component: "h1" })).container;
            var span = container.querySelector('h1');
            expect(span.innerHTML).toBe('i18n text');
        });
        it('renders a provided component with translated & interpolated content', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.fooz", component: "h1", interpolate: { foo: 'FOO', bar: 'BAR' } })).container;
            var span = container.querySelector('h1');
        ...
        it('renders a provided component with translated & interpolated content with html', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.foofoo", component: "h1", interpolate: { foo: 'FOO', bar: 'BAR' } })).container;
            var span = container.querySelector('h1');
        ...
        it('renders a provided component with translated, sanitized & interpolated content', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.foodirty", component: "h1", interpolate: { foo: 'FOO', bar: 'BAR' } })).container;
            var span = container.querySelector('h1');
        ...
        it('renders a default span with translated content for empty string', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.barfalsy.empty" })).container;
            var span = container.querySelector('span');
            expect(span.innerHTML).toBe('');
        });
        it('renders a default span with translated content for number 0', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.barfalsy.zero" })).container;
            var span = container.querySelector('span');
            expect(span.innerHTML).toBe('0');
        });
        it('renders a default span with translated content for boolean false', function () {
            var container = react_1.render(React.createElement(index_1.Translate, { contentKey: "foo.barfalsy.false" })).container;
            var span = container.querySelector('span');
...
describe('translate service', function () {
    ...
    it('produce translated content', function () {
        var out = index_1.translate('foo.bar');
        expect(out).toBe('i18n text');
    });
    it('produce translated React component', function () {
        var container = react_1.render(index_1.translate('foo.foozfooz')).container;
        var span = container.querySelector('span');
