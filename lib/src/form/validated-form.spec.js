...
var validated_form_1 = require("./validated-form");
describe('ValidatedInput', function () {
    describe('with basic text input', function () {
        it('without default value renders an empty input', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedInput, { name: "test-1" })).container;
        ...
        it('with id doesnt use name as default id in input', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedInput, { name: "test-1", id: "my-id" })).container;
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with custom tag value renders an custom input', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedInput, { name: "test-1", tag: reactstrap_1.CustomInput, type: "radio", id: "test" })).container;
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with custom string tag value renders an custom input', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedInput, { name: "test-1", tag: "select", id: "test" })).container;
        ...
        it('with default value renders an input with value', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedInput, { name: "test-1", defaultValue: "hello", isTouched: true })).container;
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
            expect(input.type).toEqual('text');
            expect(input.className).toEqual('form-control');
    ...
    describe('with register renders', function () {
        ...
        it('without default value renders an empty input', function () {
            var container = (0, react_1.render)(React.createElement(InputApp, { name: "test", defaultValue: "" })).container;
            var input = container.querySelector('input');
        ...
        it('with default value renders an input', function () {
            var container = (0, react_1.render)(React.createElement(InputApp, { name: "test", defaultValue: "hello", isTouched: true })).container;
            var input = container.querySelector('input');
            expect(input.name).toEqual('test');
            expect(input.type).toEqual('text');
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            container = (0, react_1.render)(React.createElement(InputApp, { name: "test", defaultValue: "hello", validate: { required: 'this is required' }, onChange: mockChange })).container;
                                            ...
                                            return [4 /*yield*/, (0, react_1.waitFor)(function () { return expect(react_1.screen.getByText('this is required')).not.toBeNull(); })];
                                        case 1:
                                            _a.sent();
                                            input = container.querySelector('input');
...
describe('ValidatedField', function () {
    describe('with basic text input', function () {
        it('without default value & label renders an empty input', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedField, { name: "test-1" })).container;
        ...
        it('with custom tags renders a custom input', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedField, { name: "test-1", tag: "fieldset", inputTag: reactstrap_1.CustomInput, id: "test" })).container;
            var fg = container.querySelector('fieldset.form-group');
            expect(fg).not.toBeNull();
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
            expect(input.type).toEqual('text');
        ...
        it('with label renders an input with label', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedField, { name: "test-1", defaultValue: "hello", isTouched: true, label: "Label" })).container;
        ...
        it('with row renders an input in a column', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedField, { name: "test-1", defaultValue: "hello", isTouched: true, label: "Label", row: true })).container;
            var col = container.querySelector('div.col');
        ...
        it('with check renders an input before label', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedField, { name: "test-1", label: "Label", check: true })).container;
            var fg = container.querySelector('div.form-check');
            expect(fg).not.toBeNull();
            expect(fg.innerHTML).toEqual('<input name="test-1" id="test-1" type="text" class="form-control"><label id="test-1Label" class="form-check-label">Label</label>');
        });
    });
    describe('with register renders', function () {
        function InputApp(_a) {
...
describe('ValidatedBlobField', function () {
    describe('with basic input', function () {
        it('without default value, register & label renders an empty file input', function () {
            var container = (0, react_1.render)(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1" })).container;
            var fg = container.querySelector('div.form-group');
            expect(fg).not.toBeNull();
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with custom tags renders a custom input', function () {
            var container = (0, react_1.render)(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1", tag: "fieldset", inputTag: 'input', id: "test" })).container;
            var fg = container.querySelector('fieldset.form-group');
            expect(fg).not.toBeNull();
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with label renders an input with label', function () {
            var container = (0, react_1.render)(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1", isTouched: true, label: "Label", id: "my-id" })).container;
            var col = container.querySelector('div.col');
            expect(col).toBeNull();
            var fg = container.querySelector('div.form-group');
            expect(fg).not.toBeNull();
        ...
        it('with row renders an input in a column', function () {
            var container = (0, react_1.render)(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1", isTouched: true, label: "Label", row: true })).container;
            var col = container.querySelector('div.col');
            expect(col).not.toBeNull();
            var fg = container.querySelector('div.form-group');
            expect(fg).not.toBeNull();
    ...
    describe('with register renders', function () {
        function InputApp(_a) {
            ...
            var _b = (0, react_hook_form_1.useForm)({ mode: 'onChange' }), register = _b.register, handleSubmit = _b.handleSubmit, setValue = _b.setValue, errors = _b.formState.errors;
            return (React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
                React.createElement(validated_form_1.ValidatedBlobField, __assign({ register: register, setValue: setValue, name: name, error: errors[name], role: "textbox" }, rest)),
                React.createElement("button", { type: "submit", role: "submit" }, "SUBMIT")));
        }
        it('without default value renders an empty inputs with no data preview', function () {
            var container = (0, react_1.render)(React.createElement(InputApp, { name: "test", defaultValue: "" })).container;
            var inputContentType = container.querySelector('input');
            ...
            var input = container.querySelector('input.custom-file-input');
            expect(input.name).toEqual('test');
        ...
        it('with default value renders an input with data preview for image', function () {
            var container = (0, react_1.render)(React.createElement(InputApp, { name: "test", defaultValue: "hello", id: "my-id", defaultContentType: "image/jpg", isTouched: true, isImage: true, imageClassName: "my-image" })).container;
            var inputContentType = container.querySelector('input');
            expect(inputContentType.name).toEqual('testContentType');
            var input = container.querySelector('input.custom-file-input');
            expect(input.name).toEqual('test');
            ...
            var div = container.querySelector('div.jhi-validated-blob-field-item-container');
            expect(div).not.toBeNull();
            var img = container.querySelector('img.my-image');
        ...
        it('with default value renders an input with data preview for blob', function () {
            var container = (0, react_1.render)(React.createElement(InputApp, { name: "test", defaultValue: "hello", defaultContentType: "text/pdf", isTouched: true, openActionLabel: "open this", clearBtn: function () { return React.createElement("button", { className: "my-btn" }); } })).container;
            var inputContentType = container.querySelector('input');
            expect(inputContentType.name).toEqual('testContentType');
            var input = container.querySelector('input.custom-file-input');
            expect(input.name).toEqual('test');
            ...
            var div = container.querySelector('div.jhi-validated-blob-field-item-container');
            expect(div).not.toBeNull();
            var anchor = container.querySelector('a.jhi-validated-blob-field-item-anchor');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.act)(function () { return __awaiter(void 0, void 0, void 0, function () {
                                var _a, container, getByRole, inputContentType, input, img;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            _a = (0, react_1.render)(React.createElement(InputApp, { name: "test", defaultValue: "hello", defaultContentType: "image/jpg", validate: { required: 'this is required' }, onChange: mockChange, isImage: true, imageClassName: "my-image" })), container = _a.container, getByRole = _a.getByRole;
                                            inputContentType = container.querySelector('input');
                                            expect(inputContentType.name).toEqual('testContentType');
                                            ...
                                            expect(img).not.toBeNull();
                                            expect(img.src).toEqual('data:image/jpg;base64,hello');
                                            react_1.fireEvent.change(getByRole('textbox'), {
                                                target: {
                                                    value: '',
                                                },
                                            });
                                            expect(mockChange).toBeCalled();
                                            react_1.fireEvent.submit(react_1.screen.getByRole('submit'));
                                            return [4 /*yield*/, (0, react_1.waitFor)(function () { return expect(react_1.screen.getByText('this is required')).not.toBeNull(); })];
                                        case 1:
                                            _b.sent();
                                            input = container.querySelector('input.custom-file-input');
...
describe('ValidatedForm', function () {
    describe('with non-input children', function () {
        it('renders them as single element', function () {
            var container = (0, react_1.render)(React.createElement(index_1.ValidatedForm, { onSubmit: function () { }, className: "myform" },
    ...
    describe('with validated input & field children', function () {
        it('should override register, error, isTouched & isDirty', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = (0, react_1.render)(React.createElement(index_1.ValidatedForm, { onSubmit: function () { }, className: "myform" },
        ...
        describe('renders them with default values passed via form', function () {
            it('for text field', function () {
                var container = (0, react_1.render)(React.createElement(index_1.ValidatedForm, { onSubmit: function () { }, className: "myform", defaultValues: {
                        test1: 'test1',
                        test2: 'test2',
                    } },
        ...
        describe('validate the form with no default values', function () {
            ...
            beforeEach(function () {
                (0, react_1.render)(React.createElement(index_1.ValidatedForm, { onSubmit: onSubmit, className: "myform" },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            react_1.fireEvent.submit(react_1.screen.getByRole('button'));
                            // await for first one
                            return [4 /*yield*/, (0, react_1.waitFor)(function () { return expect(react_1.screen.queryByText('Your email is required.')).toBeNull(); })];
                        case 1:
                            // await for first one
                            _a.sent();
        ...
        describe('validate the form with default values', function () {
            ...
            beforeEach(function () {
                (0, react_1.render)(React.createElement(index_1.ValidatedForm, { onSubmit: onSubmit, className: "myform", defaultValues: {
                        email: 'test@test.com',
                        password: 'password',
                        active: true,
                        select: 'v1',
...
describe('isEmail', function () {
    it('should return false when passed object is not an email', function () {
        expect((0, validated_form_1.isEmail)('foo')).toEqual(false);
        expect((0, validated_form_1.isEmail)('123foo')).toEqual(false);
        expect((0, validated_form_1.isEmail)('foo123foo')).toEqual(false);
        expect((0, validated_form_1.isEmail)('foo123.fr')).toEqual(false);
        expect((0, validated_form_1.isEmail)('foo123@me')).toEqual(false);
        expect((0, validated_form_1.isEmail)({})).toEqual(false);
        expect((0, validated_form_1.isEmail)([10])).toEqual(false);
        expect((0, validated_form_1.isEmail)(true)).toEqual(false);
        expect((0, validated_form_1.isEmail)('evan.sharp@availity')).toEqual(false);
        expect((0, validated_form_1.isEmail)('evan.sharp@')).toEqual(false);
        expect((0, validated_form_1.isEmail)('@availity.com')).toEqual(false);
        expect((0, validated_form_1.isEmail)('evan.sharp@.com')).toEqual(false);
        expect((0, validated_form_1.isEmail)('evan.sharp')).toEqual(false);
        expect((0, validated_form_1.isEmail)('availity.com')).toEqual(false);
        expect((0, validated_form_1.isEmail)('Evan@Sharp@Availity.com')).toEqual(false);
    });
    it('should return true when passed object is an email or undefined', function () {
        expect((0, validated_form_1.isEmail)(false)).toEqual(true);
        expect((0, validated_form_1.isEmail)('')).toEqual(true);
        expect((0, validated_form_1.isEmail)([])).toEqual(true);
        expect((0, validated_form_1.isEmail)(null)).toEqual(true);
        expect((0, validated_form_1.isEmail)(undefined)).toEqual(true);
        expect((0, validated_form_1.isEmail)('me@me.com')).toEqual(true);
        expect((0, validated_form_1.isEmail)('evan.sharp@availity.com')).toEqual(true);
        expect((0, validated_form_1.isEmail)('evan.sharp+more-things@availity.com')).toEqual(true);
        expect((0, validated_form_1.isEmail)('evan.sharp@availity.com.co')).toEqual(true);
        expect((0, validated_form_1.isEmail)('evan.sharp@development.availity.com')).toEqual(true);
        expect((0, validated_form_1.isEmail)('Evan.Sharp@Availity.com')).toEqual(true);
    });
});
