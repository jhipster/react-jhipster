...
describe('ValidatedInput', function () {
    describe('with basic text input', function () {
        ...
        it('with id doesnt use name as default id in input', function () {
            var container = react_1.render(React.createElement(index_1.ValidatedInput, { name: "test-1", id: "my-id" })).container;
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with custom tag value renders an custom input', function () {
            var container = react_1.render(React.createElement(index_1.ValidatedInput, { name: "test-1", tag: reactstrap_1.CustomInput, type: "radio", id: "test" })).container;
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with custom string tag value renders an custom input', function () {
            var container = react_1.render(React.createElement(index_1.ValidatedInput, { name: "test-1", tag: "select", id: "test" })).container;
...
describe('ValidatedField', function () {
    describe('with basic text input', function () {
        ...
        it('with custom tags renders a custom input', function () {
            var container = react_1.render(React.createElement(index_1.ValidatedField, { name: "test-1", tag: "fieldset", inputTag: reactstrap_1.CustomInput, id: "test" })).container;
...
describe('ValidatedBlobField', function () {
    describe('with basic input', function () {
        it('without default value, register & label renders an empty file input', function () {
            var container = react_1.render(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1" })).container;
            var fg = container.querySelector('div.form-group');
            expect(fg).not.toBeNull();
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with custom tags renders a custom input', function () {
            var container = react_1.render(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1", tag: "fieldset", inputTag: 'input', id: "test" })).container;
            var fg = container.querySelector('fieldset.form-group');
            expect(fg).not.toBeNull();
            var input = container.querySelector('input');
            expect(input.name).toEqual('test-1');
        ...
        it('with label renders an input with label', function () {
            var container = react_1.render(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1", isTouched: true, label: "Label", id: "my-id" })).container;
            var col = container.querySelector('div.col');
            expect(col).toBeNull();
            var fg = container.querySelector('div.form-group');
            expect(fg).not.toBeNull();
        ...
        it('with row renders an input in a column', function () {
            var container = react_1.render(React.createElement(validated_form_1.ValidatedBlobField, { name: "test-1", isTouched: true, label: "Label", row: true })).container;
            var col = container.querySelector('div.col');
            expect(col).not.toBeNull();
            var fg = container.querySelector('div.form-group');
            expect(fg).not.toBeNull();
    ...
    describe('with register renders', function () {
        function InputApp(_a) {
            ...
            var _b = react_hook_form_1.useForm({ mode: 'onChange' }), register = _b.register, handleSubmit = _b.handleSubmit, setValue = _b.setValue, errors = _b.formState.errors;
            return (React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
        ...
        it('with default value renders an input with data preview for image', function () {
            var container = react_1.render(React.createElement(InputApp, { name: "test", defaultValue: "hello", id: "my-id", defaultContentType: "image/jpg", isTouched: true, isImage: true, imageClassName: "my-image" })).container;
            var inputContentType = container.querySelector('input');
            expect(inputContentType.name).toEqual('testContentType');
            var input = container.querySelector('input.custom-file-input');
            expect(input.name).toEqual('test');
        ...
        it('with default value renders an input with data preview for blob', function () {
            var container = react_1.render(React.createElement(InputApp, { name: "test", defaultValue: "hello", defaultContentType: "text/pdf", isTouched: true, openActionLabel: "open this", clearBtn: function () { return React.createElement("button", { className: "my-btn" }); } })).container;
            var inputContentType = container.querySelector('input');
            expect(inputContentType.name).toEqual('testContentType');
            var input = container.querySelector('input.custom-file-input');
            expect(input.name).toEqual('test');
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, react_1.act(function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            _a = react_1.render(React.createElement(InputApp, { name: "test", defaultValue: "hello", defaultContentType: "image/jpg", validate: { required: 'this is required' }, onChange: mockChange, isImage: true, imageClassName: "my-image" })), container = _a.container, getByRole = _a.getByRole;
...
describe('isEmail', function () {
    it('should return false when passed object is not an email', function () {
        expect(validated_form_1.isEmail('foo')).toEqual(false);
        expect(validated_form_1.isEmail('123foo')).toEqual(false);
        expect(validated_form_1.isEmail('foo123foo')).toEqual(false);
        expect(validated_form_1.isEmail('foo123.fr')).toEqual(false);
        expect(validated_form_1.isEmail('foo123@me')).toEqual(false);
        expect(validated_form_1.isEmail({})).toEqual(false);
        expect(validated_form_1.isEmail([10])).toEqual(false);
        expect(validated_form_1.isEmail(true)).toEqual(false);
        expect(validated_form_1.isEmail('evan.sharp@availity')).toEqual(false);
        expect(validated_form_1.isEmail('evan.sharp@')).toEqual(false);
        expect(validated_form_1.isEmail('@availity.com')).toEqual(false);
        expect(validated_form_1.isEmail('evan.sharp@.com')).toEqual(false);
        expect(validated_form_1.isEmail('evan.sharp')).toEqual(false);
        expect(validated_form_1.isEmail('availity.com')).toEqual(false);
        expect(validated_form_1.isEmail('Evan@Sharp@Availity.com')).toEqual(false);
    });
    it('should return true when passed object is an email or undefined', function () {
        expect(validated_form_1.isEmail(false)).toEqual(true);
        expect(validated_form_1.isEmail('')).toEqual(true);
        expect(validated_form_1.isEmail([])).toEqual(true);
        expect(validated_form_1.isEmail(null)).toEqual(true);
        expect(validated_form_1.isEmail(undefined)).toEqual(true);
        expect(validated_form_1.isEmail('me@me.com')).toEqual(true);
        expect(validated_form_1.isEmail('evan.sharp@availity.com')).toEqual(true);
        expect(validated_form_1.isEmail('evan.sharp+more-things@availity.com')).toEqual(true);
        expect(validated_form_1.isEmail('evan.sharp@availity.com.co')).toEqual(true);
        expect(validated_form_1.isEmail('evan.sharp@development.availity.com')).toEqual(true);
        expect(validated_form_1.isEmail('Evan.Sharp@Availity.com')).toEqual(true);
    });
});
