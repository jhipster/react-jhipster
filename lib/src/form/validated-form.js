...
function ValidatedForm(_a) {
    ...
    return (react_1.default.createElement(reactstrap_1.Form, __assign({ onSubmit: handleSubmit(onSubmit) }, rest), react_1.default.Children.map(children, function (child) {
        var _a;
        ...
        if (isValidated) {
            ...
            return react_1.default.createElement(type, __assign({}, elem));
        }
        return child;
    })));
}
...
function ValidatedInput(_a) {
    var name = _a.name, _b = _a.id, id = _b === void 0 ? name : _b, register = _a.register, error = _a.error, isTouched = _a.isTouched, isDirty = _a.isDirty, validate = _a.validate, children = _a.children, className = _a.className, onChange = _a.onChange, onBlur = _a.onBlur, attributes = __rest(_a, ["name", "id", "register", "error", "isTouched", "isDirty", "validate", "children", "className", "onChange", "onBlur"]);
    if (!register) {
        return (react_1.default.createElement(reactstrap_1.Input, __assign({ name: name, id: id, className: className, onChange: onChange, onBlur: onBlur }, attributes), children));
    }
    className = className || '';
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(reactstrap_1.Input, __assign({ name: registeredName, id: id, valid: isTouched && !error, invalid: !!error, innerRef: ref, className: className, onChange: function (e) {
...
function ValidatedField(_a) {
    ...
    var input = (react_1.default.createElement(ValidatedInput, __assign({ name: name, id: id, disabled: disabled, className: inputClass, hidden: hidden, tag: inputTag }, attributes), children));
    var inputRow = row ? react_1.default.createElement(reactstrap_1.Col, __assign({}, col), input) : input;
...
function ValidatedBlobField(_a) {
    ...
    var renderFormGroup = function (inner) { return (react_1.default.createElement(reactstrap_1.FormGroup, { disabled: disabled, row: row, className: className, hidden: hidden, tag: tag },
        ...
        inner)); };
    var inputRow = function (input) { return (row ? react_1.default.createElement(reactstrap_1.Col, __assign({}, col), input) : input); };
    if (!register) {
        return renderFormGroup(inputRow(react_1.default.createElement(reactstrap_1.Input, __assign({ type: "file", id: id, name: name, className: className, onChange: onChange, onBlur: onBlur }, attributes))));
    }
    className = className || '';
    className = isTouched ? className + " is-touched" : className;
    className = isDirty ? className + " is-dirty" : className;
    ...
    var input = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(reactstrap_1.Input, __assign({ type: "file", id: id, name: name, valid: isTouched && !error, invalid: !!error, className: className, onChange: function (e) {
