...
function ValidatedInput(_a) {
    ...
    if (!register) {
        return (React.createElement(reactstrap_1.Input, __assign({ name: name, id: id, className: className, onChange: onChange, onBlur: onBlur }, attributes), children));
    }
    className = className || '';
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(reactstrap_1.Input, __assign({ name: registeredName, id: id, valid: isTouched && !error, invalid: !!error, innerRef: ref, className: className, onChange: function (e) {
...
function ValidatedBlobField(_a) {
    ...
    var _c = (0, react_1.useState)(defaultValue), blob = _c[0], setBlobData = _c[1];
    var _d = (0, react_1.useState)(defaultContentType), blobContentType = _d[0], setBlobContentType = _d[1];
    ...
    if (!register) {
        return renderFormGroup(inputRow(React.createElement(reactstrap_1.CustomInput, __assign({ type: "file", id: id, name: name, className: className, onChange: onChange, onBlur: onBlur }, attributes))));
    }
    className = className || '';
    className = isTouched ? className + " is-touched" : className;
    className = isDirty ? className + " is-dirty" : className;
    ...
    var input = (React.createElement(React.Fragment, null,
        ...
        React.createElement(reactstrap_1.CustomInput, __assign({ type: "file", id: id, name: name, valid: isTouched && !error, invalid: !!error, className: className, onChange: function (e) {
    ...
    return renderFormGroup(React.createElement(React.Fragment, null,
        ...
        blob ? (React.createElement("div", { className: "mb-3 mt-2 jhi-validated-blob-field-item-container" },
            blobContentType ? (React.createElement("a", { onClick: (0, util_1.openFile)(blobContentType, blob), className: "jhi-validated-blob-field-item-anchor" }, isImage ? (React.createElement("img", { src: "data:" + blobContentType + ";base64," + blob, style: imageStyle || { maxHeight: '100px' }, className: imageClassName })) : (openActionLabel || 'Open'))) : null,
            React.createElement("br", null),
