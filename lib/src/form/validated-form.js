...
function ValidatedForm(_a) {
    var defaultValues = _a.defaultValues, children = _a.children, onSubmit = _a.onSubmit, mode = _a.mode, rest = (0, tslib_1.__rest)(_a, ["defaultValues", "children", "onSubmit", "mode"]);
    var _b = (0, react_hook_form_1.useForm)({ mode: mode || 'onTouched', defaultValues: defaultValues }), handleSubmit = _b.handleSubmit, register = _b.register, reset = _b.reset, setValue = _b.setValue, _c = _b.formState, errors = _c.errors, touchedFields = _c.touchedFields, dirtyFields = _c.dirtyFields;
    (0, react_2.useEffect)(function () {
        reset(defaultValues);
    }, [reset, defaultValues]);
    return (react_1.default.createElement(reactstrap_1.Form, (0, tslib_1.__assign)({ onSubmit: handleSubmit(onSubmit) }, rest), react_1.default.Children.map(children, function (child) {
        var _a;
        var type = child === null || child === void 0 ? void 0 : child.type;
        var isValidated = type && ((_a = child === null || child === void 0 ? void 0 : child.props) === null || _a === void 0 ? void 0 : _a.name) && ['ValidatedField', 'ValidatedInput', 'ValidatedBlobField'].includes(type.displayName);
        if (isValidated) {
            var childName = child.props.name;
            var elem = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, child.props), { register: child.props.register || register, error: child.props.error || errors[childName], isTouched: typeof child.props.isTouched === 'undefined' ? touchedFields[childName] : child.props.isTouched, isDirty: typeof child.props.isDirty === 'undefined' ? dirtyFields[childName] : child.props.isDirty, key: childName });
            ...
            return react_1.default.createElement(type, (0, tslib_1.__assign)({}, elem));
        }
        return child;
    })));
}
...
function ValidatedInput(_a) {
    var name = _a.name, _b = _a.id, id = _b === void 0 ? name : _b, register = _a.register, error = _a.error, isTouched = _a.isTouched, isDirty = _a.isDirty, validate = _a.validate, children = _a.children, className = _a.className, onChange = _a.onChange, onBlur = _a.onBlur, attributes = (0, tslib_1.__rest)(_a, ["name", "id", "register", "error", "isTouched", "isDirty", "validate", "children", "className", "onChange", "onBlur"]);
    if (!register) {
        return (react_1.default.createElement(reactstrap_1.Input, (0, tslib_1.__assign)({ name: name, id: id, className: className, onChange: onChange, onBlur: onBlur }, attributes), children));
    }
    className = className || '';
    className = isTouched ? className + " is-touched" : className;
    className = isDirty ? className + " is-dirty" : className;
    var _c = register(name, validate), registeredName = _c.name, onBlurValidate = _c.onBlur, onChangeValidate = _c.onChange, ref = _c.ref;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(reactstrap_1.Input, (0, tslib_1.__assign)({ name: registeredName, id: id, valid: isTouched && !error, invalid: !!error, innerRef: ref, className: className, onChange: function (e) {
...
function ValidatedField(_a) {
    var children = _a.children, name = _a.name, id = _a.id, disabled = _a.disabled, className = _a.className, check = _a.check, row = _a.row, col = _a.col, tag = _a.tag, label = _a.label, labelClass = _a.labelClass, labelHidden = _a.labelHidden, inputClass = _a.inputClass, inputTag = _a.inputTag, hidden = _a.hidden, attributes = (0, tslib_1.__rest)(_a, ["children", "name", "id", "disabled", "className", "check", "row", "col", "tag", "label", "labelClass", "labelHidden", "inputClass", "inputTag", "hidden"]);
    var input = (react_1.default.createElement(ValidatedInput, (0, tslib_1.__assign)({ name: name, id: id, disabled: disabled, className: inputClass, hidden: hidden, tag: inputTag }, attributes), children));
    var inputRow = row ? react_1.default.createElement(reactstrap_1.Col, (0, tslib_1.__assign)({}, col), input) : input;
...
function ValidatedBlobField(_a) {
    var name = _a.name, register = _a.register, setValue = _a.setValue, error = _a.error, isTouched = _a.isTouched, isDirty = _a.isDirty, validate = _a.validate, children = _a.children, className = _a.className, onChange = _a.onChange, onBlur = _a.onBlur, _b = _a.id, id = _b === void 0 ? name : _b, disabled = _a.disabled, row = _a.row, col = _a.col, tag = _a.tag, label = _a.label, labelClass = _a.labelClass, labelHidden = _a.labelHidden, inputClass = _a.inputClass, inputTag = _a.inputTag, hidden = _a.hidden, defaultValue = _a.defaultValue, defaultContentType = _a.defaultContentType, isImage = _a.isImage, imageStyle = _a.imageStyle, imageClassName = _a.imageClassName, clearBtn = _a.clearBtn, openActionLabel = _a.openActionLabel, 
    // will be ignored as type will always be `file`
    type = _a.type, check = _a.check, attributes = (0, tslib_1.__rest)(_a, ["name", "register", "setValue", "error", "isTouched", "isDirty", "validate", "children", "className", "onChange", "onBlur", "id", "disabled", "row", "col", "tag", "label", "labelClass", "labelHidden", "inputClass", "inputTag", "hidden", "defaultValue", "defaultContentType", "isImage", "imageStyle", "imageClassName", "clearBtn", "openActionLabel", "type", "check"]);
    var _c = (0, react_2.useState)(defaultValue), blob = _c[0], setBlobData = _c[1];
    var _d = (0, react_2.useState)(defaultContentType), blobContentType = _d[0], setBlobContentType = _d[1];
    ...
    var renderFormGroup = function (inner) { return (react_1.default.createElement(reactstrap_1.FormGroup, { disabled: disabled, row: row, className: className, hidden: hidden, tag: tag },
        ...
        inner)); };
    var inputRow = function (input) { return (row ? react_1.default.createElement(reactstrap_1.Col, (0, tslib_1.__assign)({}, col), input) : input); };
    if (!register) {
        return renderFormGroup(inputRow(react_1.default.createElement(reactstrap_1.Input, (0, tslib_1.__assign)({ type: "file", id: id, name: name, className: className, onChange: onChange, onBlur: onBlur }, attributes))));
    }
    className = className || '';
    className = isTouched ? className + " is-touched" : className;
    className = isDirty ? className + " is-dirty" : className;
    ...
    var input = (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("input", { id: "file_" + name + "_content_type", name: contentTypeName, type: "hidden" }),
        react_1.default.createElement(reactstrap_1.Input, (0, tslib_1.__assign)({ type: "file", id: id, name: name, valid: isTouched && !error, invalid: !!error, className: className, onChange: function (e) {
                (0, util_1.setFileData)(e, function (contentType, data) {
        ...
        error && react_1.default.createElement(reactstrap_1.FormFeedback, null, error.message)));
    var defaultClearBtn = (react_1.default.createElement(reactstrap_1.Button, { color: "danger", size: "sm", onClick: clearBlob },
