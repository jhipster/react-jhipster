...
function ValidatedBlobField(_a) {
    ...
    var _c = react_1.useState(defaultValue), blob = _c[0], setBlobData = _c[1];
    var _d = react_1.useState(defaultContentType), blobContentType = _d[0], setBlobContentType = _d[1];
