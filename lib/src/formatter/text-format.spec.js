...
describe('text-format component', function () {
    ...
    describe('date format', function () {
        it('Should return Invalid Date in text when value is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        findByText = react_1.render(React.createElement(index_1.TextFormat, { value: null, type: "date" })).findByText;
                        _a = expect;
        ...
        it('Should return blank when value is invalid and blankOnInvalid is true', function () {
            var container = react_1.render(React.createElement(index_1.TextFormat, { value: null, type: "date", blankOnInvalid: true })).container;
            expect(container.firstChild).toBeNull();
        });
        it('Should return default formatted date for valid date', function () {
            var d = new Date();
            var node = react_1.render(React.createElement(index_1.TextFormat, { value: d, type: "date" }));
            expect(node.findByText(dayjs(d).format())).not.toBeNull();
        });
        it('Should return formatted date for valid date and format', function () {
            var d = new Date();
            var node = react_1.render(React.createElement(index_1.TextFormat, { value: d, type: "date", format: "DD MM YY" }));
            ...
            locales.forEach(function (locale) {
                formats.forEach(function (format) {
                    it("Should return a valid date formatted with format '" + format + "' in '" + locale + "'", function () {
                        var d = new Date();
                        var node = react_1.render(React.createElement(index_1.TextFormat, { value: d, type: "date", format: format, locale: locale }));
    ...
    describe('number format', function () {
        it('Should return 0 in text when value is invalid', function () {
            var node = react_1.render(React.createElement(index_1.TextFormat, { value: null, type: "number" }));
            expect(node.findByText('0')).not.toBeNull();
        });
        it('Should return blank when value is invalid and blankOnInvalid is true', function () {
            var container = react_1.render(React.createElement(index_1.TextFormat, { value: null, type: "number", blankOnInvalid: true })).container;
            expect(container.firstChild).toBeNull();
        });
        it('Should return default formatted number for valid number', function () {
            var n = 100000;
            var node = react_1.render(React.createElement(index_1.TextFormat, { value: n, type: "number" }));
            expect(node.findByText('100,000')).not.toBeNull();
        });
        it('Should return formatted number for valid number and format', function () {
            var n = 100000.1234;
            var node = react_1.render(React.createElement(index_1.TextFormat, { value: n, type: "number", format: "0,0.00" }));
            ...
            describe("using locale: '" + locale + "'", function () {
                ...
                ['$0,0.00', '$ 0,0[.]00'].forEach(function (format) {
                    it("Should return a number formatted with format '" + format + "' in '" + locale + "'", function () {
                        var n = 100000.1234;
                        var node = react_1.render(React.createElement(index_1.TextFormat, { value: n, type: "number", format: format, locale: locale }));
